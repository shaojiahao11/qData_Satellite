# deploy-frontend.ps1
# Full upload version — NO rsync, NO zip, same remote logic as original
...
try {
# --- Build Frontend (with clean dist) ---
...
# --- 🔥 CRITICAL: Clean remote new directory first (UNCHANGED) ---
...
# --- 🚫 REMOVE RSYNC, USE FULL SCP UPLOAD ---
Write-Host "📤 Uploading ALL files via scp (full transfer)..." -ForegroundColor Yellow
...
# --- Atomic Switch (EXACTLY SAME AS ORIGINAL) ---
